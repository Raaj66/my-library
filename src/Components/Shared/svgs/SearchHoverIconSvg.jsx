...
const SearchHoverIconSvg = ({ className, ...props }) => (
  <svg {...props} className={className} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="22px" height="22px" viewBox="0 0 22 22" xmlSpace="preserve">
    <style type="text/css">
      ...
      .st2{fill - rule:evenodd;clip-rule:evenodd;fill:#2CA8E2;}'}
    </style>
    <g className="st0">
      <path
        className="st1"
...
export default SearchHoverIconSvg;

SearchHoverIconSvg.propTypes = {
  className: PropTypes.string,
};

SearchHoverIconSvg.defaultProps = {
  className: '',
};
